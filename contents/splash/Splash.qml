/*
 *   Copyright 2022 Marco Martin [Edited By Saurabh Wadekar INDIA ] <mart@kde.org>
 *
...
Image {
    id: root
    source: "images/HD No Logo PL 2025.png"
    ...
    LinearGradient  {
        ...
        source: text
        gradient: Gradient {
             GradientStop { position: 0; color: "#00a4cc" }
             GradientStop { position: 0.4; color: "#00a4cc" }
             GradientStop { position: 0.6; color: "#0058cc" }
             GradientStop { position: 1; color: "#0058cc" }
        }
    }
}
